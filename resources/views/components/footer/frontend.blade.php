<footer class="bg-gradient-to-r from-dark/2.5 to-dark/5 dark:from-light/2.5 dark:to-light/5">
    <div class="container">
        ...
        <p class="py-8 border-t text-sm text-dark/70 border-dark/10 dark:border-light/10 dark:text-light/70">&copy; {{ now()->format('Y') }} {{ config('app.name') }}. All rights reserved.</p>
    </div>
</footer>