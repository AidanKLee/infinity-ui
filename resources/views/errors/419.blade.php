    ...
    <x-layouts.frontend>
        <section class="relative">
            ...
            <div class="relative z-[2] container flex flex-col items-center justify-center h-full space-y-4">
                ...
                <h1 class="text-7xl font-bold text-center text-black/80 dark:text-white/80">419</h1>
                <p class="text-lg text-center text-black/60 dark:text-white/60">Uh-oh! Your session has expired. Please refresh and try again.</p>
