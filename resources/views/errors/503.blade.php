    ...
    <x-layouts.frontend>
        <section class="relative">
            ...
            <div class="container flex flex-col items-center justify-center h-full space-y-4">
                ...
                <h1 class="text-7xl font-bold text-center text-black/80 dark:text-white/80">503</h1>
                <p class="text-lg text-center text-black/60 dark:text-white/60">We're currently down for maintenance. Please check back later.</p>
